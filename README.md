...
| L0/L1 | L0.1 text ownership complete; L0.2 next | Shared immutable text/position snapshots, bounded persistent edits, zero-copy H0 projection, active qualification/stress authorities, and approved-runner evidence now precede identity/bind/Program ownership and incremental parsing before H1 runtime work |
