...
| H2 | Non-bundle declaration output (H2.7b) complete; H2.7c declaration diagnostics and options in progress | [Current progress](docs/design/greenfield/post-h1-completion-slices.md) and [H2.7b close](docs/design/greenfield/slices/h2-7b-ca.md): 1,557 exact declaration cases, zero known divergences, 36 later-owned cases. Earlier transform/map residual queues remain separate. |
