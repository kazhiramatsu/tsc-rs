...
| H2 | Sliced; H2.0a evidence/profile transition next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), beginning with a new owner/converse inventory and exact candidate dispositions before implied-format ESM/CommonJS runtime expansion |
