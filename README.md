...
| L0/L1 | L0.4 qualified; L1 next | Shared text/position snapshots, domain-scoped identity leases, owned bind/Program snapshots, ephemeral H0 ownership, and registry reuse are performance-qualified before incremental parsing and H1 runtime work |
