...
The remaining 17 of 241 host-resolution rows still require later H0.2 and H0.3
resolver and consumer slices; general filesystem-backed resolution is not
complete.
...
| H0 | Active (H0.0–H0.1 complete; H0.2 partial, 224/241 host rows closed) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
...
| --- | --- |
| All bands | **99.9653%** (49,007 / 49,024) |
| 2xxx all-corpus visibility | **99.9192%** (21,034 / 21,051) |
