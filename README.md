...
| H2 | H2.0a/H2.0b and H2.1a–H2.1d module-format ESM/CommonJS/AMD/UMD/System complete; H2.1e Node formats next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 262 fully exact rows, 5 output-exact diagnostic controls, 28 source-deferred rows, exact System runner and dependency/setter/execute owner controls, and immutable H0/H1/L1/resource lineage |
