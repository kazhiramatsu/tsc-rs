...
| H2 | H2.0a/H2.0b and H2.1a implied-format ESM complete; H2.1b CommonJS next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 241 fully exact H2.1a rows, 5 output-exact diagnostic controls, 49 source-deferred rows, and immutable H0/H1/L1/resource lineage before the CommonJS transform closure |
