...
| H2 | H2.0a/H2.0b, H2.1a–H2.1e module formats, and H2.2a–H2.2d TypeScript transforms complete; H2.3a JavaScript source/output families next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 302 fully exact rows, 5 output-exact diagnostic controls, zero H2.2d-deferred rows, exact enum/namespace/parameter-property/import-equals/export-equals behavior across the admitted module formats, and immutable H0/H1/L1/resource lineage |
