...
| L0/L1 | L0.4 implementation complete; qualification pending | Shared text/position snapshots, domain-scoped identity leases, owned bind/Program snapshots, ephemeral H0 ownership, and registry reuse now precede approved qualification and incremental parsing before H1 runtime work |
