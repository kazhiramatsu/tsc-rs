...
phase-9 2XXX sweep is also complete; M7 grammar/unused/suggestion work
is next. Every merge to `main` must keep the accepted match sets
set-monotone (identity ratchet) while holding the FP=0 gate; the numbers
below are generated from the checked-in accepted state, never edited by
hand.
...
| --- | --- |
| All bands | **64.1053%** (31,427 / 49,024) |
