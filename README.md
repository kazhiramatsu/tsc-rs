...
| H2 | H2.0a/H2.0b, H2.1a–H2.1e module formats, H2.2a runtime/const enums, H2.2b namespaces, and H2.2c parameter properties complete; H2.2d import/export-equals next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 293 fully exact rows, 5 output-exact diagnostic controls, zero H2.2c-deferred rows, 3 inherited H2.2d source controls, exact enum/namespace/parameter-property behavior plus Node16/18/20/Next controls, and immutable H0/H1/L1/resource lineage |
