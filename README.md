...
| H2 | H2.0a/H2.0b and H2.1a/H2.1b module-format ESM/CommonJS complete; H2.1c AMD/UMD next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 251 fully exact rows, 5 output-exact diagnostic controls, 39 source-deferred rows, exact CommonJS multi-file/helper/failure evidence, and immutable H0/H1/L1/resource lineage |
