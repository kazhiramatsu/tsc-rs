...
H0.1 is complete. H0.2 follows with general host-backed module and
...
| H0 | Active (H0.1 complete) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
