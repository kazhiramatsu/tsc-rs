...
construction is not complete; H0.4 remains the active next boundary.
...
| H0 | Active (H0.0–H0.1 complete; reviewed H0.2/H0.3 rows closed 241/241; H0.4 next) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
