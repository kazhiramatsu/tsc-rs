...
| H2 | H2.0a/H2.0b, H2.1a–H2.1e module formats, H2.2a runtime/const enums, and H2.2b namespaces complete; H2.2c parameter properties/class TypeScript syntax next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 287 fully exact rows, 5 output-exact diagnostic controls, 3 source-deferred rows, exact enum and namespace runtime/export-container behavior plus Node16/18/20/Next controls, and immutable H0/H1/L1/resource lineage |
