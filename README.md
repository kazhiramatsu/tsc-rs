...
helper shape. The remaining 11 of 241 host-resolution rows still require later
H0.2 and H0.3 resolver and consumer slices; general filesystem-backed
...
| H0 | Active (H0.0–H0.1 complete; H0.2/H0.3 partial, 230/241 host rows closed) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
...
| --- | --- |
| All bands | **99.9776%** (49,013 / 49,024) |
| 2xxx all-corpus visibility | **99.9477%** (21,040 / 21,051) |
