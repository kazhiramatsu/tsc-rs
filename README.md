...
for the TypeScript sibling. M7 reuses the approach that made the 2XXX
sweep effective: measure exact oracle rows first, group them into
...
| --- | --- |
| All bands | **66.5817%** (32,641 / 49,024) |
