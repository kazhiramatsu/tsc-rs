...
| L0/L1 | L0.2 identity leases complete; L0.3 next | Shared text/position snapshots, domain-scoped node/array/symbol/private-name leases, generated relocation, non-contiguous Program ownership, reclamation stress, and approved-runner evidence now precede owned bind/Program snapshots and incremental parsing before H1 runtime work |
