...
| `node_modules`, package `exports`/`imports`, `paths`, and `typeRoots` resolution | Bounded in-memory package exports/imports, conditions, and self-reference slices available internally; general resolution remains in development |
...
36 package-imports-self-references-and-conditions rows. The remaining 26 of
241 host-resolution rows still require later H0.2 and H0.3 resolver and
consumer slices; general filesystem and type-reference resolution are not
complete.
...
| H0 | Active (H0.0–H0.1 complete; H0.2 partial, 215/241 host rows closed) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
...
| --- | --- |
| All bands | **99.9470%** (48,998 / 49,024) |
| 2xxx all-corpus visibility | **99.8765%** (21,025 / 21,051) |
