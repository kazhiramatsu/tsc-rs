...
| H2 | H2.0a/H2.0b and H2.1a–H2.1e module formats complete; H2.2a runtime/const enums next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 266 fully exact rows, 5 output-exact diagnostic controls, 24 source-deferred rows, exact Node16/18/20/Next mixed-format/package/extension/attribute controls, and immutable H0/H1/L1/resource lineage |
