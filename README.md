...
| H2 | Declaration output, diagnostics and options complete through H2.7c; H2.7d bundles and H2.7e maps in progress | [Current progress](docs/design/greenfield/post-h1-completion-slices.md) and [H2.7c close](docs/design/greenfield/slices/h2-7c-ca.md): 31 exact declaration-option cases, 11 later-owned cases, and 244 focused windows checked twice. Earlier transform/map residual queues remain separate. |
