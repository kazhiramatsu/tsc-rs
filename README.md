...
observations, native case profiles, and realpaths; central decoding,
recursive loading, and Memory/Fs program equivalence remain.
...
| H0 | Active (H0.0–H0.1 complete; reviewed H0.2/H0.3 rows closed 241/241; H0.4 filesystem primitive partial) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
