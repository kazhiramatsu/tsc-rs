...
| H2 | H2.0a/H2.0b, H2.1a–H2.1e module formats, and H2.2a runtime/const enums complete; H2.2b namespaces next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 272 fully exact rows, 5 output-exact diagnostic controls, 18 source-deferred rows, exact enum runtime/preservation/inlining and Node16/18/20/Next controls, and immutable H0/H1/L1/resource lineage |
