...
diagnostic. The remaining 4 of 241 host-resolution rows require the later H0.3
untyped-package consumer slice; general filesystem-backed resolution is not
complete.
...
| H0 | Active (H0.0–H0.1 complete; H0.2/H0.3 partial, 237/241 host rows closed) | Filesystem-hosted `--noEmit`: resolution, config/CLI, rendering, and exit behavior |
...
| --- | --- |
| All bands | **99.9918%** (49,020 / 49,024) |
| 2xxx all-corpus visibility | **99.9810%** (21,047 / 21,051) |
