...
| H0 | Active (H0.0–H0.1 complete; reviewed H0.2/H0.3 rows closed 241/241; H0.4 bounded loader and focused project-config execution partial) | Filesystem-hosted `--noEmit`: program construction, config/CLI, rendering, and exit behavior |
