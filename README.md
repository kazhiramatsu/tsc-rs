...
| H2 | Bundles and declaration maps complete through H2.7e (PR #511, 2026-09-07); next H2.8a | [Current progress](docs/design/greenfield/post-h1-completion-slices.md) and [D/E close](docs/design/greenfield/slices/h2-7de-ca.md): 291 exact cases in the joint band, 34 later-owned cases; bundle output and declaration maps preserve complete output observations. Earlier transform/map residual queues remain separate. |
