...
| H2 | H2.0a/H2.0b evidence and pre-runtime baselines complete; H2.1a next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 50 owner roots, all 15,642 runner rows dispositioned, and H0/H1/L1/resource/activity baselines frozen before implied-format ESM/CommonJS runtime expansion |
