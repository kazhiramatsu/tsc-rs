...
| H2 | H2.0a/H2.0b and H2.1a–H2.1c module-format ESM/CommonJS/AMD/UMD complete; H2.1d System next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 257 fully exact rows, 5 output-exact diagnostic controls, 33 source-deferred rows, exact AMD/UMD runner and static dependency/name controls, and immutable H0/H1/L1/resource lineage |
