...
| H2 | H2.0a evidence/profile transition complete; H2.0b baselines next | [Branch-sized broad one-shot compiler slices](docs/design/greenfield/post-h1-completion-slices.md), with 50 owner roots and all 15,642 runner rows dispositioned before implied-format ESM/CommonJS runtime expansion |
