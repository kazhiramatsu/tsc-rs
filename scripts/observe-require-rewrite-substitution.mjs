// Frozen complete-command witnesses for source require/import rewriting.
// node scripts/observe-require-rewrite-substitution.mjs require-rewrite-substitution --write|--check
...
const GROUPS = { "require-rewrite-substitution": 4 };
