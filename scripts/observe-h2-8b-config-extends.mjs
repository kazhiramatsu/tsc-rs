...
// node scripts/observe-h2-8b-config-extends.mjs --write|--check
...
const inputPath = "crates/program/tests/fixtures/h2-8b-config-extends-inputs.json";
const outputPath = "crates/program/tests/fixtures/h2-8b-config-extends.json";
...
const anchors = [
  ["parseJsonSourceFileConfigFileContent", 38973, 38991],
  ["parseJsonConfigFileContentWorker", 39004, 39171],
  ["handleOptionConfigDirTemplateSubstitution", 39175, 39239],
  ["parseConfig", 39272, 39330],
  ["parseOwnConfigOfJsonSourceFile", 39379, 39435],
  ["getExtendedConfig", 39460, 39499],
