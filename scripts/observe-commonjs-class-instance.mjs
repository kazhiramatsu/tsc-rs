// H2.8a CommonJS class instance. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/commonjs-class-instance.json");
...
const jsShapes = [
 ["instance", 'class Foo { static stat = 10; member = 10; }\nmodule.exports = new Foo();\n'],
 ["added-member", 'class Foo { static stat = 10; member = 10; }\nmodule.exports = new Foo();\nmodule.exports.additional = 20;\n'],
 ["same-member", 'class Foo { member = 10; }\nmodule.exports = new Foo();\nmodule.exports.member = 20;\n'],
 ["constructor", 'class Foo { static stat = 10; member = 10; }\nmodule.exports = Foo;\n'],
 ["object", 'module.exports = { member: 10 };\n'],
 ["local-instance", 'class Foo { member = 10; }\nconst value = new Foo();\nmodule.exports = value;\n'],
 ["factory-instance", 'class Foo { member = 10; }\nfunction make() { return new Foo(); }\nmodule.exports = make();\n'],
 ["generic-instance", '/** @template T */\nclass Foo { /** @param {T} value */ constructor(value) { this.value = value; } }\nmodule.exports = new Foo(1);\n'],
 ["derived-instance", 'class Base { member = 10; }\nclass Foo extends Base { own = 20; }\nmodule.exports = new Foo();\n'],
 ["anonymous-instance", 'module.exports = new class { member = 10; }();\n'],
 ["private-instance", 'class Foo { #member = 10; read() { return this.#member; } }\nmodule.exports = new Foo();\n'],
 ["accessor-instance", 'class Foo { get member() { return 10; } set member(value) {} }\nmodule.exports = new Foo();\n'],
];
const tsShapes = [
 ["instance", 'class Foo { static stat = 10; member = 10; }\nexport = new Foo();\n'],
 ["constructor", 'class Foo { static stat = 10; member = 10; }\nexport = Foo;\n'],
 ["object", 'export = { member: 10 };\n'],
 ["generic-instance", 'class Foo<T> { constructor(public value: T) {} }\nexport = new Foo(1);\n'],
];
const inputs=[];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [extension,shapes] of [["js",jsShapes],["ts",tsShapes]]) for (const [shape,text] of shapes) {
  const main="/project/main."+extension;
  inputs.push({case_id:`${targetName}/${extension}/${shape}`,roots:[main],files:[{path:main,text}],
...
console.log(`CommonJS class instance: ${cases.length} cases, two identical complete observations each`);
