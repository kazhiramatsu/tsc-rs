// Complete TypeScript Program commands for retained constructor references.
...
const inputPath = "crates/compiler/tests/fixtures/retained-constructor-reference-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/retained-constructor-references.json");
