...
// node scripts/observe-h2-8b-config-diagnostic-commands.mjs config-diagnostic-commands --write|--check [destination]
...
const GROUPS = { "config-diagnostic-commands": 12 };
