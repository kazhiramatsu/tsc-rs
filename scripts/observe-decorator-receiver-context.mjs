// Complete TypeScript Program commands for decorator receiver contexts.
...
const inputPath = "crates/compiler/tests/fixtures/decorator-receiver-context-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/decorator-receiver-context.json");
