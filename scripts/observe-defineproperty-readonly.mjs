// H2.8a DefineProperty readonly descriptors. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/defineproperty-readonly.json");
...
const shapes = [
  ...
  [
    "value-false",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable: false });\n"
  ],
  [
    "value-true",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable: true });\n"
  ],
  [
    "value-undefined-writable",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable: undefined });\n"
  ],
  [
    "value-quoted-false",
    "js",
  ...
  [
    "value-and-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, set(supplied) {} });\n"
  ],
  [
    "identifier-set",
    "js",
  ...
  [
    "getter-only",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { get() { return 1; } });\n"
  ],
  [
    "quoted-getter-only",
    "js",
  ...
  [
    "getter-and-setter",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { get() { return 1; }, set(supplied) {} });\n"
  ],
  [
  ...
  [
    ...
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { set: undefined });\n"
  ],
  [
    "empty-descriptor",
    "js",
  ...
  [
    "false-const",
    "js",
    "class Foo {}\nconst writable = false;\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable });\n"
  ],
  [
    "true-const",
    "js",
  ...
  [
    "boolean-let",
    "js",
    "class Foo {}\nlet writable = Math.random() > 0.5;\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable });\n"
  ],
  [
    "false-conditional",
    "js",
    "class Foo {}\nconst writable = Math.random() > 0.5 ? false : false;\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable });\n"
  ],
  [
    "boolean-cast",
    "js",
    "class Foo {}\n\nObject.defineProperty(Foo.prototype, \"x\", { value: 1, writable: /** @type {boolean} */ (false) });\n"
  ],
  [
  ...
  [
    "descriptor-variable-false",
    "js",
    "class Foo {}\nconst descriptor = { value: 1, writable: false };\nObject.defineProperty(Foo.prototype, \"x\", descriptor);\n"
  ],
  [
    "descriptor-variable-true",
    "js",
    "class Foo {}\nconst descriptor = { value: 1, writable: true };\nObject.defineProperty(Foo.prototype, \"x\", descriptor);\n"
  ],
  [
    "descriptor-variable-set",
    "js",
    "class Foo {}\nconst descriptor = { set(supplied) {} };\nObject.defineProperty(Foo.prototype, \"x\", descriptor);\n"
  ],
  [
    "descriptor-call-value",
    "js",
    "class Foo {}\nfunction descriptor() { return { value: 1 }; }\nObject.defineProperty(Foo.prototype, \"x\", descriptor());\n"
  ],
  [
    "descriptor-call-set",
    "js",
    "class Foo {}\nfunction descriptor() { return { set(supplied) {} }; }\nObject.defineProperty(Foo.prototype, \"x\", descriptor());\n"
  ],
  [
    "repeated-set-then-value",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { set(supplied) {} });\nObject.defineProperty(Foo.prototype, \"x\", { value: 1 });\n"
  ],
  [
    "repeated-value-then-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", { value: 1 });\nObject.defineProperty(Foo.prototype, \"x\", { set(supplied) {} });\n"
  ],
  [
    "static-value-false",
    "js",
    "class Foo {}\nObject.defineProperty(Foo, \"x\", { value: 1, writable: false });\n"
  ],
  [
    "static-quoted-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo, \"x\", { \"set\"(supplied) {} });\n"
  ],
  [
    "assignment-false",
    "js",
  ...
  [
    "assignment-quoted-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", {\"set\"(supplied) {}});\nnew Foo().x = 2;\n"
  ],
  [
    "assignment-computed-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", {[\"set\"](supplied) {}});\nnew Foo().x = 2;\n"
  ],
  [
  ...
  [
    "ts-get-and-set",
    "ts",
    "class Foo { get x() { return 1; } set x(value: number) {} }\nnew Foo().x = 2;\n"
  ],
  [
    "ts-const-assignment",
    "ts",
  ...
  [
    "ts-mapped-readonly",
    "ts",
    "class Foo { x = 1; }\nconst item: Readonly<Foo> = new Foo(); item.x = 2;\n"
  ],
  [
    "ts-mapped-strip",
    "ts",
    "class Foo { readonly x = 1; }\ntype Mutable<T> = {-readonly [K in keyof T]: T[K]};\nconst item: Mutable<Foo> = new Foo(); item.x = 2;\n"
  ],
  [
    "ts-union-readonly",
    "ts",
    "class Foo { readonly x = 1; }\ndeclare const item: Foo | {x: number}; item.x = 2;\n"
  ],
  [
    "ts-intersection-readonly",
    "ts",
    "class Foo { readonly x = 1; }\ndeclare const item: Foo & {x: number}; item.x = 2;\n"
  ],
  [
    "ts-object-spread",
    "ts",
    "class Foo { readonly x = 1; }\nconst item = {...new Foo()}; item.x = 2;\n"
  ],
  [
    "ts-structural-identity",
    "ts",
    "class Foo { readonly x = 1; }\ndeclare const readonly: {readonly x: number};\nconst writable: {x: number} = readonly; writable.x = 2;\n"
  ],
  [
    "descriptor-any",
    "js",
  ...
  [
    "descriptor-union",
    "js",
    "class Foo {}\nconst descriptor = Math.random() > 0.5 ? {value: 1, writable: false} : {set(supplied) {}};\nObject.defineProperty(Foo.prototype, \"x\", descriptor);\n"
  ],
  [
    "descriptor-intersection",
    "js",
    "class Foo {}\n/** @type {{value: number} & {writable: false}} */\nconst descriptor = {value: 1, writable: false};\nObject.defineProperty(Foo.prototype, \"x\", descriptor);\n"
  ],
  [
    "writable-getter",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", {value: 1, get writable() {return false;}});\n"
  ],
  [
    "delete-false",
    "js",
  ...
  [
    "value-undefined-and-set",
    "js",
    "class Foo {}\nObject.defineProperty(Foo.prototype, \"x\", {value: undefined, set(supplied) {}});\nnew Foo().x = 1;\n"
  ]
];
const inputs=[];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [moduleName,module] of [["commonjs",ts.ModuleKind.CommonJS],["esnext",ts.ModuleKind.ESNext]]) for (const [shape,extension,text] of shapes) {
  ...
  inputs.push({case_id:`defineproperty-readonly/${targetName}/${moduleName}/${shape}`,roots:[main],
...
console.log(`DefineProperty readonly descriptors: ${cases.length} cases, two identical complete observations each`);
