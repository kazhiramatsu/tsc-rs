// H2.8a local alias declaration witnesses. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/local-alias-declarations.json");
...
const inputs = [];
const js = [
 ["require-renamed", 'const ns = require("./ns");\nmodule.exports.names = ns;'],
 ["require-same", 'const ns = require("./ns");\nmodule.exports.ns = ns;'],
 ["local-renamed", 'class Local {}\nexports.Other = Local;'],
 ["class-named", 'exports.Other = class Local {};'],
 ["class-anonymous", 'exports.Other = class {};'],
 ["compound-local", 'const scope = { Inner: class Inner {} };\nexports.Other = scope.Inner;'],
 ["compound-require", 'const ns = require("./ns");\nexports.Other = ns.Foo;'],
 ["module-exports-member", 'exports.First = class First {};\nexports.Second = module.exports.First;'],
 ["object-shorthand", 'class Local {}\nmodule.exports = { Local };'],
 ["object-renamed", 'class Local {}\nmodule.exports = { Other: Local };'],
 ["default", 'class Local {}\nexport default Local;'],
 ["export-equals", 'class Local {}\nmodule.exports = Local;'],
];
const typescript = [
 ["namespace-import", 'import * as ns from "./ns";\nexport {ns as names};'],
 ["local-renamed", 'class Local {}\nexport {Local as Other};'],
 ["default", 'class Local {}\nexport default Local;'],
 ["export-equals", 'class Local {}\nexport = Local;'],
];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [extension,forms] of [["js",js],["ts",typescript]]) for (const [name,text] of forms) {
  const main = "/project/main."+extension;
  inputs.push({case_id:`${extension}/${targetName}/${name}`,roots:[main],
   files:[{path:main,text:text+"\n"},{path:"/project/ns.js",text:"export class Foo {}\n"}],
...
console.log(`Local alias declarations: ${cases.length} cases, two identical complete observations each`);
