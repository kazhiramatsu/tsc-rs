...
const inputPath = "crates/program/tests/fixtures/h2-8b-config-discovery-paths-inputs.json";
const outputPath = "crates/program/tests/fixtures/h2-8b-config-discovery-paths.json";
