...
// node scripts/observe-h2-8b-config-diagnostics.mjs --write|--check
...
const inputPath = "crates/program/tests/fixtures/h2-8b-config-diagnostics-inputs.json";
const outputPath = "crates/program/tests/fixtures/h2-8b-config-diagnostics.json";
const inputs = JSON.parse(fs.readFileSync(path.join(root, inputPath), "utf8"));
assert.equal(inputs.cases.length, 76);
