// H2.8a JSDoc parentheses guard. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/jsdoc-parentheses-guard.json");
...
const tag = "/** @type {'a' | 'b'} */\n";
const shapes = [
 ["declaration-one", tag + "let value = (x);\n"],
 ["declaration-three", tag + "let value = (((x)));\n"],
 ["declaration-no-parens", tag + "let value = x;\n"],
 ["no-tag-one", "let value = (x);\n"],
 ["inline-type-one", tag + "let value = /** @type {'a' | 'b'} */ (x);\n"],
 ["inline-type-three", tag + "let value = /** @type {'a' | 'b'} */ (((x)));\n"],
 ["inline-satisfies", "let value = /** @satisfies {'a' | 'b'} */ (x);\n"],
 ["declaration-inline-satisfies", tag + "let value = /** @satisfies {'a' | 'b'} */ (x);\n"],
 ["declaration-comment-one", tag + "let value = /** retained comment */ (x);\n"],
 ["declaration-literal", tag + "let value = ('a');\n"],
];
const inputs=[];
...
console.log(`JSDoc parentheses guard: ${cases.length} cases, two identical complete observations each`);
