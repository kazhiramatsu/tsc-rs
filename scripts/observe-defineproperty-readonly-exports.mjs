// H2.8a DefineProperty readonly exports. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/defineproperty-readonly-exports.json");
...
const shapes = [
  [
    "exports-shorthand-false",
    "js",
    "const writable = false;\nObject.defineProperty(exports, \"x\", {value: 1, writable});\nexports.x = 2;\n"
  ],
  [
    "exports-quoted-set",
    "js",
    "Object.defineProperty(exports, \"x\", {\"set\"(supplied) {}});\nexports.x = 2;\n"
  ],
  [
    "module-exports-variable-false",
    "js",
    "const descriptor = {value: 1, writable: false};\nObject.defineProperty(module.exports, \"x\", descriptor);\nmodule.exports.x = 2;\n"
  ],
  [
    "module-exports-computed-set",
    "js",
    "Object.defineProperty(module.exports, \"x\", {[\"set\"](supplied) {}});\nmodule.exports.x = 2;\n"
  ]
];
const inputs=[];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [moduleName,module] of [["commonjs",ts.ModuleKind.CommonJS],["esnext",ts.ModuleKind.ESNext]]) for (const [shape,extension,text] of shapes) {
  ...
  inputs.push({case_id:`defineproperty-readonly-exports/${targetName}/${moduleName}/${shape}`,roots:[main],
   files:[{path:main,text:text+'exports.tail = 1;\n'}],
...
console.log(`DefineProperty readonly exports: ${cases.length} cases, two identical complete observations each`);
