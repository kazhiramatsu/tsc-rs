// Pinned raw-position and original-parent predicates for list sibling lines.
...
walk(source);
const names = ['getSeparatingLineTerminatorCount', 'nodeIsSynthesized', 'originalNodesHaveSameParent', 'rangeEndIsOnSameLineAsRangeStart', 'getStartPositionOfRange', 'positionsAreOnSameLine', 'getLinesBetweenPositions', 'synthesizedNodeStartsOnNewLine', 'getStartsOnNewLine'];
...
const artifact = { version: 1, slice: 'H2.8a-A6-40',
  ...
  observer: { path: 'scripts/observe-list-separating-sources.mjs', sha256: sha256(fs.readFileSync(import.meta.filename)) },
  owners };
const output = 'ratchets/h2-8a-list-separating-sources.v1.json';
