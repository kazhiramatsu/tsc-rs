...
expected_ids = set()
for fixture in ["h2-8a-require-rewrite.json", "h2-8a-require-rewrite-composition.json"]:
...
assert "test result: ok. 3 passed; 0 failed" in log
...
receipt = {
    ...
    "supplemental_command_executions": 128,
    "captures": captures,
...
print("64 focused/composition + 2 original commands exact twice; 45 repairs, 15 preserved positives; 128 supplemental captures exact")
