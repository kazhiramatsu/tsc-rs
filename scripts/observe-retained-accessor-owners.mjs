// Complete TypeScript Program commands for retained accessors and decorator handoff.
...
const inputPath = "crates/compiler/tests/fixtures/retained-accessor-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/retained-accessor-owners.json");
...
assert.equal(inputs.length, 148);
