// Pinned whole owners for the isolated CommaListElements design amendment.
...
walk(source);
const names = ['emitCommaList', 'emitExpressionList', 'emitNodeList', 'emitNodeListItems',
  'getLeadingLineTerminatorCount', 'getSeparatingLineTerminatorCount', 'getClosingLineTerminatorCount',
  'getStartsOnNewLine', 'getCommentRange', 'getEmitFlags', 'getEmitListItem',
  'emitListItemWithParenthesizerRule', 'emitListItemNoParenthesizer', 'writeDelimiter',
  'emitLeadingCommentsOfPosition', 'emitLeadingComments', 'emitLeadingComment',
  'emitTrailingCommentsOfPosition', 'emitTrailingComment', 'emitTrailingCommentOfPosition',
  'forEachLeadingCommentToEmit', 'forEachTrailingCommentToEmit',
  'emitCommentsBeforeNode', 'emitCommentsAfterNode', 'emitLeadingCommentsOfNode', 'emitTrailingCommentsOfNode'];
...
const artifact = { version: 1, slice: 'H2.8a-A6-40',
  ...
  observer: { path: 'scripts/observe-comma-printer-sources.mjs', sha256: sha256(fs.readFileSync(import.meta.filename)) },
  owners };
const output = 'ratchets/h2-8a-comma-printer-sources.v1.json';
