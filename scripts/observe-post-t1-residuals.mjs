// H2.8a-A-RES-POST-T1 observer: complete TypeScript 6.0.3 commands
// for the adjacent controls of `generate-post-t1-residuals-inputs.mjs` (same
...
//
// usage: node scripts/observe-post-t1-residuals.mjs --write|--check [--case <substr>]... [--out <path>]
...
const inputPath = "crates/compiler/tests/fixtures/post-t1-residuals-inputs.json";
const destination = scratchOut ?? path.join(root, "crates/compiler/tests/fixtures/post-t1-residuals.json");
