// H2.8a Class helper accessor producers. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/class-helper-accessor-producers.json");
...
const shapes = [
  [
    "anonymous-private-get-set",
    "const Foo = class { static #self: any = this; static get self(): any { return this.#self; } static set self(value: any) { this.#self = value; } }; export { Foo };"
  ],
  [
    "anonymous-auto-accessor",
    "const Foo = class { static accessor self: any = this; }; export { Foo };"
  ],
  [
    "instance-private-with-static",
    "const Foo = class { #value = 1; read() { return this.#value; } static self: any = this; }; export { Foo };"
  ],
  [
    "named-private-control",
    "const Foo = class Inner { static #self: any = this; static get self(): any { return this.#self; } }; export { Foo };"
  ],
  [
    "declaration-private-control",
    "export class Foo { static #self: any = this; static get self(): any { return this.#self; } }"
  ],
  [
    "nested-private-names",
    "const Foo = class { static nested = class { static #self: any = this; static get self(): any { return this.#self; } }; static #self: any = this; static get self(): any { return this.#self; } }; export { Foo };"
  ],
  [
    "preceding-private-request",
    "class First { #value = 1; read() { return this.#value; } } const Foo = class { static accessor self: any = this; }; export { First, Foo };"
  ],
  [
    "heritage-private-request",
    "class Base { static #base = class {}; static get base() { return this.#base; } } const Foo = class extends Base.base { static accessor self: any = this; }; export { Base, Foo };"
  ],
  [
    "named-auto-accessor-control",
    "const Foo = class Inner { static accessor self: any = this; }; export { Foo };"
  ],
  [
    "declaration-auto-accessor-control",
    "export class Foo { static accessor self: any = this; }"
  ],
  [
    "instance-auto-accessor-control",
    "export class Foo { accessor value = 1; read() { return this.value; } }"
  ],
  [
    "static-modifier-comments",
    "export class Foo { /* field */ static /* static */ accessor self: any = this; }"
  ]
];
const inputs=[];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015],["es2022",ts.ScriptTarget.ES2022]]) {
 for (const [moduleName,module] of [["commonjs",ts.ModuleKind.CommonJS],["esnext",ts.ModuleKind.ESNext]]) {
  for (const useDefineForClassFields of [false,true]) for (const [shape,body,extra={}] of shapes) {
   ...
   inputs.push({case_id:`class-helper-accessor-producers/${targetName}/${moduleName}/${mode}/${shape}`, roots:[main],
...
console.log(`Class helper accessor producers: ${cases.length} cases, two identical complete observations each`);
