...
// node scripts/observe-h2-8b-config-root-boundaries.mjs --write|--check
...
const inputPath = "crates/program/tests/fixtures/h2-8b-config-root-boundaries-inputs.json";
const outputPath = "crates/program/tests/fixtures/h2-8b-config-root-boundaries.json";
