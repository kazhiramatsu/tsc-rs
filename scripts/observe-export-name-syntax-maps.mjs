...
const destination = path.join(root, "crates/compiler/tests/fixtures/export-name-syntax-maps.json");
...
const defaults = { strict:true, allowJs:true, checkJs:true, declaration:true, sourceMap:true,
  ...
  outDir:"/project/out" };
const shapes = [
 ["local-single-quote", "const value = 1;\nexport { value as 'default' };\n"],
 ["external-single-quote", "export { 'value' as 'named' } from './lib';\n"],
 ["update-single-quote", "let value = 1;\nexport { value as 'default' };\nvalue++;\n"],
 ["direct-extended-unicode", "export const \\u{10400} = 1;\n"],
];
const inputs = [];
...
console.log(`Export name syntax maps: ${cases.length} cases, two identical complete observations each`);
