// Complete TypeScript Program commands for retained comma factory injection.
...
const inputPath = "crates/compiler/tests/fixtures/retained-comma-factory-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/retained-comma-factory.json");
