// H2.8a class statement layout and computed binding witnesses. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/class-statement-layout.json");
...
const inputs = [];
const forms = [
 ["static-first", 'function make() { class Box { static value = 1; } return Box; }\n'],
 ["static-middle", 'function make() { const prefix = 0; class Box { static value = 1; } return Box; }\n'],
 ["static-last", 'function make() { const prefix = 0; class Box { static value = 1; } }\n'],
 ["static-only", 'function make() { class Box { static value = 1; } }\n'],
 ["static-multiline", 'function make() {\n  class Box { static value = 1; }\n  return Box;\n}\n'],
 ["static-arrow", 'const make = () => { class Box { static value = 1; } return Box; };\n'],
 ["static-function-expression", 'const make = function () { class Box { static value = 1; } return Box; };\n'],
 ["static-method", 'class Maker { make() { class Box { static value = 1; } return Box; } }\n'],
 ["instance-explicit-constructor", 'function touch() {}\nclass Box { value = 1; constructor() { touch(); } }\n'],
 ["instance-two-properties", 'class Box { first = 1; second = 2; constructor() {} }\n'],
 ["static-expression", 'function make() { const Box = class { static value = 1; }; return Box; }\n'],
 ["plain-class", 'function make() { class Box { method() { return 1; } } return Box; }\n'],
 ["computed-static-instance", 'const first = "a"; const second = "b"; class Box { static [first] = 1; [second] = 2; }\n'],
 ["computed-static-static", 'const first = "a"; const second = "b"; class Box { static [first] = 1; static [second] = 2; }\n'],
 ["computed-instance-instance", 'const first = "a"; const second = "b"; class Box { [first] = 1; [second] = 2; }\n'],
 ["computed-with-constructor-local", 'const first = "a"; const second = "b"; class Box { static [first] = 1; [second] = 2; constructor(value = second) { const local = value; } }\n'],
];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) for (const extension of ["js","ts"]) {
...
console.log(`Class statement layout: ${cases.length} cases, two identical complete observations each`);
