// H2.8a DefineProperty setter parameter names. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/defineproperty-setter-names.json");
...
const shapes = [
 ["descriptor-repeated-call-order","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set(first) {} });\nObject.defineProperty(Foo.prototype, "x", { set(second) {} });\n'],
 ["descriptor-duplicate-member-order","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set: function (first) {}, set(second) {} });\n'],
 ["descriptor-variable-argument","js",'class Foo {}\nconst descriptor = { /** @param {number} supplied */ set(supplied) {} };\nObject.defineProperty(Foo.prototype, "x", descriptor);\n'],
 ["descriptor-call-argument","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", Object.freeze({ /** @param {number} supplied */ set(supplied) {} }));\n'],
 ["descriptor-method","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { /** @param {number} supplied */ set(supplied) {} });\n'],
 ["descriptor-get-set","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { get() { return 1; }, /** @param {number} supplied */ set(supplied) {} });\n'],
 ["descriptor-rest","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { /** @param {number[]} args */ set(...args) {} });\n'],
 ["descriptor-noarg","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set() {} });\n'],
 ["descriptor-object-binding","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set({ value }) {} });\n'],
 ["descriptor-array-binding","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set([value]) {} });\n'],
 ["descriptor-quoted-method","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { "set"(supplied) {} });\n'],
 ["descriptor-computed-method","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { ["set"](supplied) {} });\n'],
 ["descriptor-function-property","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set: function (supplied) {} });\n'],
 ["descriptor-arrow-property","js",'class Foo {}\nObject.defineProperty(Foo.prototype, "x", { set: supplied => {} });\n'],
 ["descriptor-identifier-property","js",'const setter = supplied => {};\nclass Foo {}\nObject.defineProperty(Foo.prototype, "x", { set: setter });\n'],
 ["descriptor-union-property","js",'const first = supplied => {};\nconst second = alternative => {};\nclass Foo {}\nObject.defineProperty(Foo.prototype, "x", { set: Math.random() ? first : second });\n'],
 ["descriptor-static-method","js",'class Foo {}\nObject.defineProperty(Foo, "x", { /** @param {number} supplied */ set(supplied) {} });\n'],
 ["actual-js-setter","js",'class Foo { /** @param {number} supplied */ set x(supplied) {} }\n'],
 ["actual-js-get-set","js",'class Foo { get x() { return 1; } /** @param {number} supplied */ set x(supplied) {} }\n'],
 ["actual-js-private-setter","js",'class Foo { /** @private @param {number} supplied */ set x(supplied) {} }\n'],
 ["actual-ts-setter","ts",'class Foo { set x(supplied: number) {} }\n'],
 ["anonymous-ts-private-setter","ts",'const Foo = class { private set x(supplied: number) {} };\n'],
];
const inputs=[];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [moduleName,module] of [["commonjs",ts.ModuleKind.CommonJS],["esnext",ts.ModuleKind.ESNext]]) for (const [shape,extension,text] of shapes) {
  ...
  inputs.push({case_id:`setter-names/${targetName}/${moduleName}/${shape}`,roots:[main],
   files:[{path:main,text:text+'export { Foo };\nexport const tail = 1;\n'}],
...
console.log(`DefineProperty setter parameter names: ${cases.length} cases, two identical complete observations each`);
