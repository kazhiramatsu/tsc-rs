// H2.8a class declaration dependency-order witnesses. Expectations are complete TS commands.
...
const destination = path.join(root, "crates/compiler/tests/fixtures/class-declaration-dependency-order.json");
...
const inputs = [];
const base = 'const Base = require("./base");\n';
const labels = 'const Labels = { a: "A", b: "B" };\n';
const member = 'const Member = require("./member");\n';
const forms = [
 ["base-namespace", base+labels+'class Derived extends Base {}\nmodule.exports = Derived;\nmodule.exports.Labels = Labels;'],
 ["reverse-namespace", base+labels+'class Derived extends Base {}\nmodule.exports.Labels = Labels;\nmodule.exports = Derived;'],
 ["duplicate-base", base+labels+'class Derived extends Base {}\nmodule.exports = Derived;\nmodule.exports.Base = Base;\nmodule.exports.Labels = Labels;'],
 ["member-after-base", base+member+labels+'class Derived extends Base { /** @type {Member} */ field; }\nmodule.exports = Derived;\nmodule.exports.Labels = Labels;'],
 ["member-without-merge", base+member+'class Derived extends Base { /** @type {Member} */ field; }\nmodule.exports = Derived;'],
 ["class-no-base", labels+'class Derived {}\nmodule.exports = Derived;\nmodule.exports.Labels = Labels;'],
 ["private-local-base", labels+'class Base {}\nclass Derived extends Base {}\nmodule.exports = Derived;\nmodule.exports.Labels = Labels;'],
 ["two-derived", base+labels+'class First extends Base {}\nclass Second extends Base {}\nmodule.exports = { First, Second, Labels };'],
];
const typed = [
 ["private-base", 'class Base {}\nexport class Derived extends Base {}'],
 ["namespace-merge", 'class Base {}\nexport class Derived extends Base {}\nexport namespace Derived { export const value = 1; }'],
 ["member-order", 'class Base {}\nclass Member {}\nexport class Derived extends Base { field!: Member; }'],
 ["nested-scope", 'namespace Outer { class Base {}\nexport class Derived extends Base {} }\nexport = Outer;'],
];
for (const [targetName,target] of [["es5",ts.ScriptTarget.ES5],["es2015",ts.ScriptTarget.ES2015]]) {
 for (const [extension,rows] of [["js",forms],["ts",typed]]) for (const [name,text] of rows) {
  const main = "/project/main."+extension;
  inputs.push({case_id:`${extension}/${targetName}/${name}`,roots:[main],
   files:[{path:main,text:text+"\n"},{path:"/project/base.js",text:"class Base {}\nmodule.exports = Base;\n"},
    {path:"/project/member.js",text:"class Member {}\nmodule.exports = Member;\n"}],
...
console.log(`Class declaration dependency order: ${cases.length} cases, two identical complete observations each`);
