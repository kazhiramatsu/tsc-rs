// Complete TypeScript Program commands for retained lexical environments.
...
const inputPath = "crates/compiler/tests/fixtures/retained-lexical-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/retained-lexical-environments.json");
