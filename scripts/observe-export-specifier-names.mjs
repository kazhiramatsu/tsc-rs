...
const destination = path.join(root, "crates/compiler/tests/fixtures/export-specifier-names.json");
...
const inputs = [];
const forms = [
 ["local-default", 'const Thing = 1; export { Thing as default };\n'],
 ["local-renamed", 'const Thing = 1; export { Thing as Named };\n'],
 ["local-keywords", 'const Thing = 1; export { Thing as class, Thing as type };\n'],
 ["local-string-default", 'const Thing = 1; export { Thing as "default" };\n'],
 ["local-underscores", 'const __Thing = 1; export { __Thing, __Thing as __Named };\n'],
 ["local-merged-default", 'const Thing = 1; export { Thing as default };\n/** @typedef {string | number} default */\n'],
 ["external-to-default", 'export { OtherThing as default } from "./lib";\n'],
 ["external-from-default", 'export { default as Named } from "./lib";\n'],
 ["external-default", 'export { default } from "./lib";\n'],
 ["external-string-default", 'export { "default" as Named } from "./lib";\n'],
 ["external-keywords", 'export { Thing as class, Thing as type } from "./lib";\n'],
 ["external-siblings", 'export { Thing, OtherThing as default, Thing as Again } from "./lib";\n'],
];
...
console.log(`Export specifier names: ${cases.length} cases, two identical complete observations each`);
