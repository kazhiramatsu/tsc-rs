// Complete TypeScript Program commands for retained lexical edge predicates.
...
const inputPath = "crates/compiler/tests/fixtures/retained-lexical-edge-inputs.json";
const destination = path.resolve(root, process.argv[3] ?? "crates/compiler/tests/fixtures/retained-lexical-edges.json");
