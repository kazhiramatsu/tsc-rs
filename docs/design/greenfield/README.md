...
| L0/L1 persistent source + incremental parser — L0.0 evidence freeze complete; L0.1 next | [persistent Program design](lsp-and-incremental.md) | frozen work/resource evidence and CI contracts, then shared text/identity/owned bind/Program snapshots, unchanged-file reuse, incremental parse exactness, and large-file/H0 performance proof before H1 runtime work |
