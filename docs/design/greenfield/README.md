...
| L0/L1 persistent source + incremental parser — L0.2 identity leases complete; L0.3 next | [persistent Program design](lsp-and-incremental.md) | shared text/position snapshots, domain-scoped identity leases, generated relocation, non-contiguous ownership, and qualified reclamation/performance evidence, then owned bind/Program snapshots, unchanged-file reuse, and incremental parse exactness before H1 runtime work |
