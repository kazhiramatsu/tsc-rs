...
| L0/L1 persistent source + incremental parser — L0.4 implementation complete; qualification pending | [persistent Program design](lsp-and-incremental.md) | shared text/position snapshots, domain-scoped identity leases, generated relocation, non-contiguous ownership, owned bind/Program snapshots, ephemeral H0 ownership, registry reuse, and qualified performance evidence, then incremental parse exactness before H1 runtime work |
