...
| L0/L1 persistent source + incremental parser — L0.3 owned bind state complete; L0.4 next | [persistent Program design](lsp-and-incremental.md) | shared text/position snapshots, domain-scoped identity leases, generated relocation, non-contiguous ownership, owned bind/Program snapshots, and qualified performance evidence, then unchanged-file reuse and incremental parse exactness before H1 runtime work |
