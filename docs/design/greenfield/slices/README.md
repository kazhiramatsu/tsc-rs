...
| FCI-2b bounded effect-result seam | Blocked on FCI-2a and its own ready packet | No production edits; bounded reads/results remain separate from scheduling, snapshots, sandbox, publication, and cache. |
