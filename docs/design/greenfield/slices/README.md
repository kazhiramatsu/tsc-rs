...
| FCI-4a.2 graph/model structural validation | Blocked on FCI-4a.1 and its own ready packet | No production edits; cycles, edges, closures, and stable plan derivation remain separate. |
| FCI-4a.3 sealed registry/membership/testkit | Blocked on FCI-4a.2 and its own ready packet | No production edits; adapter registration and complete membership remain sealed. |
