...
H2.6b closed on the h2/6b-ca train (PR #482, 2026-08-28), and H2.6c closes
on the h2/6c-close train under [h2-6c-ca.md](h2-6c-ca.md); the H2.7a era
is next under its own opening packet ([h2-7a.md](h2-7a.md)). Read-only
