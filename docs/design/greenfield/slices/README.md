...
| FCI-3b execution/tool/sandbox identities | Blocked on FCI-3a and its own ready packet | No production edits. |
| FCI-3c source/sandbox/resource primitives | Blocked on FCI-3b and its own ready packet | No production edits. |
