...
- Bands on the fixed tree (worktree `tsc-rs-w5-x`): 5h 838 / 50 / 44 (no new divergence), 6c 321 / 318 / 4, 6a 171 / 4 / 2, 6b 6 / 0 / 0, 5g full 9,027 / 8,511, 7b 1,557 / 0 / 36; the w3b / w4b / w5b lane controls + `emit_session_contract` 98 green; xtask 270 / 0; clippy / fmt clean. Lesson (the pilot's omission): the local 5h + 6x bands (≈ 8 min) and the 5g full (≈ 25 min) before every push are cheaper than a 35-min hosted round trip; hosted reports one stale entry per run.
