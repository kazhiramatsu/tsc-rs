...
- Launch check (`preflight.py SPEC-W3-A.md SPEC-W3-B.md SPEC-W3-E.md` at E1): __PREFLIGHT_LAUNCH__ (expected: 3 disjoint sets, 0 single-writer hits, 0 missing files).
- Verify before integration (`preflight.py --verify <worktree> <SPEC>`): W3-A __VERIFY_A__; W3-B __VERIFY_B__; W3-E __VERIFY_E__.
...
- Analysis (gpt-6-astra xhigh, docs-only): the packet cross-review and the w4 residual-owner analysis — __ASTRA__.
- Integrator: E1 (packet draft, register skeleton, the three registered stubs, the 5g shadow registration) __E1__; checkpoints __CHECKPOINTS__.
