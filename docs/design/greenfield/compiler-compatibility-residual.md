...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2d/H2.3a-H2.3d/H2.4a-H2.4b/H2.5a-H2.5d complete; 632 exact corpus admissions plus exact JSON, decorator/class-field, ESNext, ES2021, ES2020, and ES2019 transform controls; H2.5e next | ES2018-and-earlier target lowering and the remaining transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
