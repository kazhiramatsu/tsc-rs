...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2d/H2.3a-H2.3d complete; 309 exact corpus admissions plus 14 exact JSON owner controls; H2.4a next | Decorator and remaining transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
