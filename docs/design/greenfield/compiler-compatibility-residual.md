...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1d complete; 262 exact ESM/CommonJS/AMD/UMD/System admissions; H2.1e next | Node formats and remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
