...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a complete; 272 exact module-format and runtime/const-enum admissions; H2.2b next | Namespaces and remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
