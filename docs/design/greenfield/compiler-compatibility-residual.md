...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a/H2.2b complete; 287 exact module-format, enum, and namespace admissions; H2.2c next | Parameter properties and remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
