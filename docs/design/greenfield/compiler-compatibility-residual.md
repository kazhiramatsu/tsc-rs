...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1c complete; 257 exact ESM/CommonJS/AMD/UMD admissions; H2.1d next | System and remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
