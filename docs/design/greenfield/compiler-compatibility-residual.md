...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2d/H2.3a-H2.3d/H2.4a-H2.4b complete; 360 exact corpus admissions plus exact JSON and decorator owner controls; H2.5a next | Target lowering and remaining transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
