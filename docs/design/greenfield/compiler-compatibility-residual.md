...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2c complete; 293 exact module-format, enum, namespace, and parameter-property admissions; H2.2d next | Import/export-equals, remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
