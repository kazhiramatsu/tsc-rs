...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2d complete; 302 exact module-format and TypeScript-transform admissions; H2.3a next | JavaScript/JSX/JSON source families, remaining transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
