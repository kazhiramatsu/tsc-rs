...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a-H2.1e/H2.2a-H2.2d/H2.3a-H2.3c complete; 309 exact module-format, TypeScript-transform, JavaScript-source, and classic/automatic-JSX admissions; H2.3d next | JSON source families, remaining transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
