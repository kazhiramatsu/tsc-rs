...
| Broad one-shot `tsc` compilation | H2.0a/H2.0b/H2.1a/H2.1b complete; 251 exact ESM/CommonJS admissions; H2.1c next | AMD/UMD/System and remaining JS transform matrix, declarations, maps, output/config/CLI matrix, and complete emit suites |
