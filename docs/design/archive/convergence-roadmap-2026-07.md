# Archived convergence roadmap, July 2026

Archived from `docs/design/README.md` when the top-level design
directory was narrowed to durable design documents. This file is kept
for historical context; prefer the current `../README.md` for the live
design index.
