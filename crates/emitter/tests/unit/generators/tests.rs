//! H2.5h-b B-3 focused projections (packet §7.3): drive the REAL
//! `GeneratorsTransformer` on parsed fixtures and byte-compare against
...
//! `{ target: ES5, alwaysStrict: false, newLine: LineFeed }` — no
//! prologue, LF. Reproduction: `node b3-probe.mjs` (script body
//! reproduced in the PR; the 72 exact sources are §7 step 3 of the
//! packet).

use tsc_program::SourceFileId;
use tsc_syntax::{parse_source_file, NodeData, NodeId};
...
/// lexical catch-clause resolution over the single parse tree (exact for
/// the §7 fixture language, whose no-shadowing constraint keeps catch
/// names unclaimed by any inner binder); every other query inherits the
/// typed fail-closed defaults.
struct FixtureResolver {
    /// (name text, catch-block start, catch-block end, declaration node)
    catches: Vec<(String, u32, u32, NodeId)>,
    /// identifier node -> (text, position)
    identifiers: std::collections::BTreeMap<NodeId, (String, u32)>,
}
...
fn project(source_text: &str) -> String {
...
function g() { var a; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            a = _a.sent();
...
function g() { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [5 /*yield**/, __values(h())];
        case 1:
            _a.sent();
            return [2 /*return*/];
    }
...
function g() { var i; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            i = 0;
            _a.label = 1;
...
function g() { var _a, _b, _c, _i, k; return __generator(this, function (_d) {
    switch (_d.label) {
        case 0:
            _a = o;
            _b = [];
...
function g() { var e_1; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, 1];
...
function g() { var _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            _a = t;
            switch (_a) {
...
function g() { var r, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            _a = a();
...
function g() { var r; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            a();
            return [4 /*yield*/, 1];
...
function g() { var _a, _b; return __generator(this, function (_c) {
    switch (_c.label) {
        case 0:
            ...
            return [4 /*yield*/, 1];
        case 1:
            _a.apply(void 0, _b.concat([_c.sent(), b()]));
            return [2 /*return*/];
    }
}); }
"#
...
function g() { var _a, _b, _c; return __generator(this, function (_d) {
    switch (_d.label) {
        case 0:
            _b = (_a = o).m;
            _c = [a()];
...
function g() { var r, _a, _b; return __generator(this, function (_c) {
    switch (_c.label) {
        case 0:
            _a = C.bind;
            _b = [void 0, a()];
            return [4 /*yield*/, 1];
        case 1:
            r = new (_a.apply(C, _b.concat([_c.sent()])))();
            use(r);
            return [2 /*return*/];
    }
}); }
...
function g() { function inner() { return 2; } return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            _a.sent();
...
function g() { var a, b; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            a = 1, b = f();
            return [4 /*yield*/, a + b];
...
function g() { var h; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            h = function () { return 1; };
            return [4 /*yield*/, h()];
...
function g() { function inner() { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            _a.sent();
    ...
    switch (_a.label) {
        case 0: return [5 /*yield**/, __values(inner())];
        case 1:
            _a.sent();
            return [2 /*return*/];
    }
...
function g(a, b) { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, a + b];
        case 1:
            _a.sent();
            return [2 /*return*/];
    }
...
var h = function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            _a.sent();
...
var h = function gen() { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            _a.sent();
...
function g() { var o; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, 1];
        case 1:
            _a.sent();
            o = { get p() { function h() { return __generator(this, function (_a) {
                    switch (_a.label) {
...
function g() { var e_1, e_2; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            _a.trys.push([0, 2, , 3]);
            return [4 /*yield*/, 1];
...
function g() { var a, b, c; return __generator(this, function (_a) {
    switch (_a.label) {
        case 0:
            a = p();
            return [4 /*yield*/, 1];
...
function g() { var r, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            ...
            return [4 /*yield*/, 1];
        case 1:
            r = (_a.y = _b.sent(), Object.defineProperty(_a, "p", { enumerable: false, configurable: true, get: function () { return 1; } }), _a);
            use(r);
            return [2 /*return*/];
    }
}); }
...
function g() { var r, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            ...
            return [4 /*yield*/, 1];
        case 1:
            r = (_a.y = _b.sent(), Object.defineProperty(_a, "p", { enumerable: false, configurable: true, get: function () { return q; }, set: function (v) { s(v); } }), _a);
            use(r);
            return [2 /*return*/];
    }
}); }
...
function g() { var r, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            ...
            return [4 /*yield*/, 1];
        case 1:
            r = (_a.y = _b.sent(), _a.m = function () { return 2; }, _a);
            use(r);
            return [2 /*return*/];
    }
}); }
...
function g() { var r, _a; return __generator(this, function (_b) {
    switch (_b.label) {
        case 0:
            ...
            return [4 /*yield*/, 1];
        case 1:
            r = (_a.y = _b.sent(), _a["s p"] = a(), _a[1] = b(), _a);
            use(r);
            return [2 /*return*/];
    }
}); }
...
/// `visitGenerator`'s `Debug.failBadSyntaxKind` arm: a generator method
...
/// `beginCatchBlock` reads `variable.name` unconditionally; the ES2019
