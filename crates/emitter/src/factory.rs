...
impl<'arena> NodeFactory<'arena> {
    ...
    /// tsc-span: _tsc.js:22407-22415
    ///
    /// P2 prerequisite: the m-3.5 census carried only this face's classifier
    /// header, not a callable typed constructor.
    ...
    ///
    /// P2 prerequisite paired with `create_object_binding_pattern` above.
