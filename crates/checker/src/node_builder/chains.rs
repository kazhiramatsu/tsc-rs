...
mod tests {
    ...
    fn nested_namespace_chain_selects_parent_qualification_and_distinct_node_forms() {
        ...
        with_builder_files(
            ...
            |checker, arena, target, context| {
                let value =
                    declaration_symbol(checker, 0, SyntaxKind::VariableDeclaration, "value");
                ...
                let entity =
                    chains_symbol_to_entity_name_node(checker, arena, target, context, value)?;
                assert_eq!(
    ...
    fn qualified_type_reference_threads_override_arguments_and_parameter_declarations() {
        ...
        with_builder_files(
            ...
            |checker, arena, target, context| {
                let symbol =
                    declaration_symbol(checker, 0, SyntaxKind::InterfaceDeclaration, "Box");
    ...
    fn external_symbol_uses_lane_h_relative_import_type_and_threads_arguments() {
        ...
        with_builder_files(
            ...
            |checker, arena, target, context| {
                ...
                let NodeData::ImportType(data) = &arena.node(node).map_err(factory_error)?.data
                else {
                    panic!(
        ...
        with_builder_files(
            ...
            |checker, arena, target, context| {
                ...
                let names = aliases
                    ...
                    .collect::<Vec<_>>();
                let first =
                    project_parse_node(checker, arena, names[0])?.expect("first alias mounted");
                let second =
