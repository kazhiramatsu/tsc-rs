//! Complete TypeScript commands for external helper imports.
...
#[test]
fn import_helpers_matches_complete_typescript_observations() {
    let artifact: serde_json::Value =
        serde_json::from_slice(include_bytes!("../fixtures/import-helpers.json")).unwrap();
