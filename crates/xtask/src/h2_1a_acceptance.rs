...
/// Execute all 295 H2.1a candidates. Fully admitted rows compare every
/// TypeScript observable twice, five trusted-base diagnostic controls retain
/// exact output but no compatibility admission, and source-deferred rows
