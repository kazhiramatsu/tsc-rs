...
const ROW_TABLE = Object.freeze([
  ...
  ["E-PRINTER-BASE", "premise-unchanged", "downlevel output uses ES5 shapes the printer already prints", {}],
  ["E-PRINTER-G", "premise-unchanged", "the H2.5g printer facts are consumed unchanged", {}],
