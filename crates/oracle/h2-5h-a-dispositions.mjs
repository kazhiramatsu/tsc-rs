...
const ROW_TABLE = Object.freeze([
  ...
  ["E-COMMENT-SCOPE-H", "activate", "the threaded comment-scope triple is implemented by comment-scope packets 2-6 before any ES2015/Generators production work; the study and ten-family witnesses are frozen; CS-2..CS-5 landed (root/core pipeline, per-side expression/list routes, statement-family migration + declaration-list writer, contextless/dual-API deletion), CS-6 remains", { surfaces: ["comment-apis"], capabilities: ["comment-scope-threading"] }],
