...
fn h2_2d_profile_is_content_addressed_and_closes_the_transition() {
    ...
    assert_eq!(
        sha256(RECORDED),
        "331bdb17a856d953d7eef521dc91512a0243faa77c4c7d2e22eb4e5dfed9bab5"
    );
    ...
    assert_recorded_exact(
        ...
        "e51366b901f531922857f06a5f75dcddb9967ff1f90efbfd85d1abdbb312a3e4",
    );
    assert_recorded_exact(
        &artifact["contract"],
        ".github/ci/contracts/h2-2d-profile.schema.json",
    ...
    for (field, expected_path, expected_hash) in [
        ...
        (
            ...
            "c7c5d157ce500c6b6fda767b0428e6003dffa1e1d1b5ad2d440c4312cea03efa",
        ),
    ] {
