...
fn project_compiler_options(options: &BTreeMap<String, OptionValue>) -> CompilerOptions {
    ...
    CompilerOptions {
        ...
        out_dir: projected_string_option(options, "outDir"),
        root_dir: projected_string_option(options, "rootDir"),
        source_map: bool_option("sourceMap"),
        inline_source_map: bool_option("inlineSourceMap"),
        inline_sources: bool_option("inlineSources"),
        source_root: projected_string_option(options, "sourceRoot"),
        map_root: projected_string_option(options, "mapRoot"),
        ...
        declaration_dir: projected_string_option(options, "declarationDir"),
        strip_internal: bool_option("stripInternal"),
        out_file: projected_string_option(options, "outFile"),
        out: projected_string_option(options, "out"),
        ...
        ts_build_info_file: projected_string_option(options, "tsBuildInfoFile"),
