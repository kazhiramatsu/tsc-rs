//! CFG1c: fresh config inheritance, converted options, roots, and diagnostics.
...
#[test]
fn config_diagnostics_matches_fresh_typescript_observations() {
    let inputs: Value = serde_json::from_slice(include_bytes!(
        "../fixtures/h2-8b-config-diagnostics-inputs.json"
    ))
